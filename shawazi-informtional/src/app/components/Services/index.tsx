...
const Services = () => {
  return (
    <div className="font-jost mx-[3%] px-[3%] py-2">
      <section>
        <div className="flex items-center justify-center mb-8">
          <hr className="w-1/2 border-t border-primary" />
          <h1 className="mx-5 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-primary">Services</h1>
          <hr className="w-1/2 border-t border-primary" />
        </div>
        <p className="text-center text-black mb-8 text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-[4px]">Explore our services and their impact</p>
